...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2018 at 08:43 PM
...
-- Database: `typingtest`
--
CREATE DATABASE IF NOT EXISTS `typingtest` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `typingtest`;
...
CREATE TABLE `highscores` (
  `uname` varchar(25) CHARACTER SET latin1 COLLATE latin1_general_cs DEFAULT NULL,
  `hnetwpm` int(4) DEFAULT NULL,
...
INSERT INTO `highscores` (`uname`, `hnetwpm`, `recdate`) VALUES
('CPU', 50, NULL),
('CPU', 60, NULL),
('CPU', 70, NULL),
('CPU', 80, NULL),
...
CREATE TABLE `userdetails` (
  ...
  `hgrosswpm` int(4) DEFAULT NULL,
  `hnetwpm` int(4) DEFAULT NULL,
  `haccuracy` int(3) DEFAULT NULL,
  `notries` int(4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `userdetails` (`uname`, `hgrosswpm`, `hnetwpm`, `haccuracy`, `notries`) VALUES
('CPU', 250, 250, 100, 10),
('Guest', 0, 0, 0, 0);
...
INSERT INTO `users` (`uname`, `upassword`, `umobile`, `uemail`, `usecque`, `usecans`) VALUES
('CPU', '123', NULL, '123', 'none', 'none'),
('Guest', 'Guest', NULL, 'Guest@mail.com', 'What is your favourite color?', 'none');
...
--
ALTER TABLE `highscores`
  ADD CONSTRAINT `highscores_ibfk_1` FOREIGN KEY (`uname`) REFERENCES `userdetails` (`uname`);

--
-- Constraints for table `userdetails`
--
ALTER TABLE `userdetails`
  ADD CONSTRAINT `userdetails_ibfk_1` FOREIGN KEY (`uname`) REFERENCES `users` (`uname`);
